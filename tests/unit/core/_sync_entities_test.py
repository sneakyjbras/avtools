...
def test_sync_entities_mixed_insert_delete_update():
    ...
    api_items = [
        DummyModel(equipment_no="DEV-34", value=404, year=1911),  # update
        DummyModel(equipment_no="DEV-2137", value=2137, year=2025),  # insert
    ]
